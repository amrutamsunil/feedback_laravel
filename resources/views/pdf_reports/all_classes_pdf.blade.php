    ...
    @if($class['theory']['subjects']!=null||$class['lab']['subjects']!=null)
        <div class="no-break">
            <div class="page-header">
                ...
                <center><h6><b>DEPARTMENT OF {{$dept->name}}</b></h6></center>
                <center><h6><b>ACADEMIC YEAR : {{config('questions.academic_year')}} ( {{config('questions.current_sem')}} )</b></h6></center>
                <center><h6><b>CLASS NAME : {{$class['class_data']['name']}}</b></h6></center>
            </div>
        ...
        @if($class['theory']['count']>0)
            <table class="table table-sm table-bordered no-break">
                <tr class="table-info" >
                    ...
                    @else
                        <td class="text-center" colspan="{{($class['theory']['count'])}}" >THEORY SUBJECTS</td>
                    @endif
        ...
        @if($class['lab']['count']>0)
            <table class="table table-sm table-bordered no-break">
                <tr class="table-info table-bordered">
                    ...
                    @else
                        <td class="text-center" colspan="{{($class['lab']['count'])}}" >LAB SUBJECTS</td>
