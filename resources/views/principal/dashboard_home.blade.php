<html>
    ...
    $feedback_count = mysqli_fetch_array($feedback_list);
        $dataPoints=array();
        array_push($dataPoints,array("y"=>$cse_count,"label"=>"CSE","indexLabel"=>"CSE : $cse_count","IndexLabelFontSize"=>18));
        array_push($dataPoints,array("y"=>$ece_count,"label"=>"ECE","indexLabel"=>"ECE :$ece_count ","IndexLabelFontSize"=>18));
        array_push($dataPoints,array("y"=>$mech_count,"label"=>"MECH","indexLabel"=>"MECH : $mech_count","IndexLabelFontSize"=>18));
        array_push($dataPoints,array("y"=>$civil_count,"label"=>"CIVIL","indexLabel"=>"CIVIL : $civil_count","IndexLabelFontSize"=>18));
        array_push($dataPoints,array("y"=>$eee_count,"label"=>"EEE","indexLabel"=>"EEE : $eee_count","IndexLabelFontSize"=>18));
        array_push($dataPoints,array("y"=>$mba_count,"label"=>"MBA","indexLabel"=>"MBA : $mba_count","IndexLabelFontSize"=>18));
        array_push($dataPoints,array("y"=>$freshers,"label"=>"S&H","indexLabel"=>"S&H : $freshers","IndexLabelFontSize"=>18));
        array_push($dataPoints,array("y"=>$feedback_count[0],"label"=>"TOTAL COUNT","indexLabel"=>"Total : $feedback_count[0]","IndexLabelFontSize"=>18));
...
<h1 align="center" style=" color: dodgerblue;text-shadow: 4px 4px 6px lightblue;"><a href="">ADMIN DASHBOARD</a></h1>
...
<script src="{{asset('css/canvasjs.min.js')}}"></script>
<?php
