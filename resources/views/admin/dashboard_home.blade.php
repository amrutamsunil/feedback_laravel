...
<head>
    ...
    $student_list = mysqli_query($conn, "select students.id from students  where class_id IN (select classes.id from classes where department_id=$dept_id and isActive=1)");
    ...
    $dataPoints = array(
        array("y" => $faculty_count, "label" => "Total Number of Faculty","indexLabel"=>"Value : $faculty_count","indexLabelFontSize"=>18,"indexLabelFontPosition"=>"outside"),
        array("y" => $student_count, "label" => "Total Number of Student ","indexLabel"=>"Value : $student_count","indexLabelFontSize"=>18,"indexLabelFontPosition"=>"outside"),
        array("y" => $feedback_count_one, "label" => "Total Number of Feedback for Phase-1","indexLabel"=>"Value : $feedback_count_one","indexLabelFontSize"=>18,"indexLabelFontPosition"=>"outside"),
        array("y" => $feedback_count_two, "label" => "Total Number of Feedback for Phase-2","indexLabel"=>"Value : $feedback_count_two","indexLabelFontSize"=>18,"indexLabelFontPosition"=>"outside"),
...
<script src="{{asset('css/canvasjs.min.js')}}"></script></center>
</div>
</body>
</html>
