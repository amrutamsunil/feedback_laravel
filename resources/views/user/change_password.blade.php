...
if(isset($update_password)) {
    if ($op == "" || $cp == "" || $np == "") {
        ...
        $err = "";
        @$err = $user_class->update_password($op, $np, $cp, $_SESSION['user']);
...
<form method="post" style="padding-left: 25%">
    <div class="back">
        <table style="margin-left: 10%;">
            ...
            <tr >
                <td rowspan="2" style="padding-left: 55%"><input type="submit" value="UPDATE PASSWORD" name="update_password" class="btn btn-info"/></td>
            </tr>
    </table>
    </div>
</form>
