...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/main_sd.css')}}" />
</head>
...
<!-- Scripts -->
<script src="{{asset('assets/js/jquery_sd.min.js')}}"></script>
<script src="{{asset('assets/js/browser_sd.min.js')}}"></script>
<script src="{{asset('assets/js/breakpoints_sd.min.js')}}"></script>
<script src="{{asset('assets/js/util_sd.js')}}"></script>
<script src="{{asset('assets/js/main_sd.js')}}"></script>
</body>
</html>